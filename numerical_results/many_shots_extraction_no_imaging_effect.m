...
[in_cosineCoeffs, in_sineCoeffs] = sampling_suite_com.compute_fourier_coeffs(com_phase(:,idx_1:idx_2),n_fourier_cutoff);

%save('main_Data/scan_11ms_16ms_50nk_80microns_10ksamples.mat', 't_tof_1', 't_tof_2', 'temp_com', 'temp_rel', 'mean_density', 'n_fourier_cutoff', 'ext_cutoff', 'grid_dens','cut_grid_dens', 'out_com_phase_t1', ...
...
%   'density_ripple_t2', 'cut_density_ripple_t2', 'idx_1', 'idx_2', 'out_sineCoeffs_t2', 'out_sineCoeffs_t1', 'out_cosineCoeffs_t2', 'out_cosineCoeffs_t1', 'in_sineCoeffs', 'in_cosineCoeffs')
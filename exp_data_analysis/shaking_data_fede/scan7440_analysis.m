...
load('scan7440_exp_data_for_phase_extraction_all.mat')
...
thermal_dr = density_ripple_all{1};
mean_thermal_dr = mean(thermal_dr, 2);
...
xlim([-20,20])
ylim([-2,2])
legend('$t = 15\; \rm ms$', '$t = 30\; \rm ms$', '$t = 47.5\; \rm ms$', 'Interpreter', 'latex', 'FontSize', 10)
xlabel('$z\; (\rm \mu m)$','Interpreter','latex')

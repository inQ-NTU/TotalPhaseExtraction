...
ylim([-3.2,3.2])
xlabel('$z\; (\rm \mu m)$','Interpreter','latex')
ylabel('$\overline{\phi_+}(z)$', 'Interpreter','latex')
box on
ax = gca;
ax.LineWidth = 1.1;
...
plot(evol_time, avg_cosineCoeffs_all(:,2)','.', 'Color', 'black', 'LineWidth',1.1)
yline(0)
ylim([-3,3])
xline(0, 'LineStyle', '--')
xlim([-35,120])
...
plot(evol_time, avg_sineCoeffs_all(:,2)', '.', 'Color', 'black', 'LineWidth',1.1)
